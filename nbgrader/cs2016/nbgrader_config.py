...
# server set up.
c.NbGrader.course_id = "cs2016"

# Update this list with other assignments you want
c.NbGrader.db_assignments = [dict(name="tg")]
...
#  `./tg`. If this is `True`, then the path will be something like
#  `./course123/tg`.
...
#c.ClearSolutions.begin_solution_delimeter = {'python': '### BEGIN SOLUTION'}
...
#c.ClearSolutions.end_solution_delimeter = {'python': '### END SOLUTION'}
